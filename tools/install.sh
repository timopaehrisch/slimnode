...
EOF
    ...
    echo "${FMT_YELLOW}On your phone, set the wireguard configuration as follows:${FMT_RESET}"
    ...
    echo -e "${FMT_YELLOW}On your workstation, your wireguard configuration should be as follows:${FMT_RESET}"
    echo -e "${FMT_YELLOW}[Interface]\nPrivateKey = <Generated by wireguard>\nAddress = 10.0.0.3/24\n\n# VPS\n[Peer]\nPublicKey = ${WG_NODE_PUB_KEY}>\nAllowedIPs = 10.0.0.1/32\nEndpoint = ${PUBLIC_IP}:51820\n${FMT_RESET}"
